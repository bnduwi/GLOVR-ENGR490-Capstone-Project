    ...
    void Update()
    {
        ...
        foreach (string item in sensors)
        {
            ...
            else if (knuckleId == "a2")
            {
                ...
                KnuckleRotatorR2(knuckleName, angle);
            }
        ...
        void KnuckleRotatorR1(string knuckName, float rotationAngle)
        {
            ...
            hand.transform.localEulerAngles = new Vector3(rotationAngle, 0, 0);
        }

        void KnuckleRotatorR2(string knuckName, float rotationAngle)
        {
            GameObject hand = GameObject.FindGameObjectWithTag(knuckleName);
            hand.transform.localEulerAngles = new Vector3(0, 0, rotationAngle);
        }
